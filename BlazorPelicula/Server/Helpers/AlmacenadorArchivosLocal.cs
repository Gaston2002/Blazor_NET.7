...
{
    //CON ESTE CODIGO PODEMOS GUARDAR UN ARCHIVO EN EL WWWROOT CREADO EN SERVIDOR Y DEVOLVER LA URL QUR SE GUARDA EN LA BASE DE DATOS 
    public class AlmacenadorArchivosLocal : IAlmacenadorArchivos
    {
            ...
            string nombreContenedor)
        {
            ...
            var urlActual = $"{httpContextAccessor!.HttpContext!.Request.Scheme}://{httpContextAccessor.HttpContext.Request.Host}"; //esquema y host
